            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                 Stay tuned for our latest services 
                </p>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="https://docs.google.com/forms/d/e/1FAIpQLSfsWo8KfRbLzgH0g4tZuuGMo-hLZ2QAHU0lN3XKqaMaf3SE2Q/viewform?pli=1"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        Careers
                      </a>
...
<button
  ...
  onClick={() => alert("Signed up for the newsletter!")} // Fake alert added
>
  <svg
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://www.facebook.com/people/Debasish-Sahu/pfbid0oF7kYgioBat6BAc6sbfvpJ3pF8ufHpw6mKs5iytokqXLMEhvTqh6QxTr5YvjdCCUl/" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a href="https://x.com/_Debasish_Sahu" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                ...
                <li>
                  <a href="https://www.linkedin.com/in/-debasish-sahu/" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
