    ...
    <>
      <div className="mt-11 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
        <ul className="flex items-center gap-6">
          ...
          <li>
            <a href="https://r.search.yahoo.com/_ylt=Awr1QO9Jhjxn9gEAR8e7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1733229386/RO=10/RU=https%3a%2f%2fwww.facebook.com%2f/RK=2/RS=bnqPuGEJP4Lb5hrhSGGLia3QnFM-" aria-label="social link">
              <svg
          ...
          <li>
            <a href="https://x.com/?lang=en-in" aria-label="social link">
              <svg
                className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                width="24"
                height="24"
          ...
          <li>
            <a href="https://r.search.yahoo.com/_ylt=AwrKAT1shjxnMQIAZxu7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1733229421/RO=10/RU=https%3a%2f%2fin.linkedin.com%2f/RK=2/RS=2orF3V7GPNOWWJu1DKcn_PhUoBA-" aria-label="social link">
              <svg
                className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                width="24"
                height="24"
